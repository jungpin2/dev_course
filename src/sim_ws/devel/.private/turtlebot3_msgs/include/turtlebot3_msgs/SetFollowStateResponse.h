...
bool operator==(const ::turtlebot3_msgs::SetFollowStateResponse_<ContainerAllocator1> & lhs, const ::turtlebot3_msgs::SetFollowStateResponse_<ContainerAllocator2> & rhs)
{
