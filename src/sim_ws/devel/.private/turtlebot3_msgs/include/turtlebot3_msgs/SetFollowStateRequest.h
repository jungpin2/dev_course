...
bool operator==(const ::turtlebot3_msgs::SetFollowStateRequest_<ContainerAllocator1> & lhs, const ::turtlebot3_msgs::SetFollowStateRequest_<ContainerAllocator2> & rhs)
{
