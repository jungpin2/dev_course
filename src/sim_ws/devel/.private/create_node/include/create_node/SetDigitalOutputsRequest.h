...
bool operator==(const ::create_node::SetDigitalOutputsRequest_<ContainerAllocator1> & lhs, const ::create_node::SetDigitalOutputsRequest_<ContainerAllocator2> & rhs)
{
  return lhs.digital_out_0 == rhs.digital_out_0 &&
    lhs.digital_out_1 == rhs.digital_out_1 &&
    lhs.digital_out_2 == rhs.digital_out_2;
}
