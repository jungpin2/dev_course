...
bool operator==(const ::create_node::TurtlebotSensorState_<ContainerAllocator1> & lhs, const ::create_node::TurtlebotSensorState_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.user_digital_outputs == rhs.user_digital_outputs &&
